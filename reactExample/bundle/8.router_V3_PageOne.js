...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.mapStateToProps_PageOne = exports.mapStateToProps_Quote = exports.mapStateToProps_Main = undefined;

	var _immutable = __webpack_require__(532);

	var _mapStateToProps_Main = __webpack_require__(749);

	var _mapStateToProps_Main2 = _interopRequireDefault(_mapStateToProps_Main);

	var _mapStateToProps_Quote = __webpack_require__(750);

	var _mapStateToProps_Quote2 = _interopRequireDefault(_mapStateToProps_Quote);

	var _mapStateToProps_PageOne = __webpack_require__(751);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.mapDispatchToProps_PageOne = exports.mapDispatchToProps_Quote = exports.mapDispatchToProps_Main = undefined;

	var _immutable = __webpack_require__(532);

	var _mapDispatchToProps_Main = __webpack_require__(753);

	var _mapDispatchToProps_Main2 = _interopRequireDefault(_mapDispatchToProps_Main);

	var _mapDispatchToProps_Quote = __webpack_require__(757);

	var _mapDispatchToProps_Quote2 = _interopRequireDefault(_mapDispatchToProps_Quote);

	var _mapDispatchToProps_PageOne = __webpack_require__(758);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Action = __webpack_require__(754);

	var _immutable = __webpack_require__(532);

	var _mapDispatchToProps_Common = __webpack_require__(755);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _common = __webpack_require__(756);
	  ...
	  return function (dispatch, getState) {
	    return {
	      onMain_TabbarClick: function onMain_TabbarClick(e, index) {
	        dispatch((0, _immutable.fromJS)(_Action.Action.Main_TabbarClickAction).mergeDeep({
	          e: e,
	          index: index
	        }).toJSON());
	        (0, _common.Ajax)({
	          ...
	          doneFun: function doneFun(msg) {
	            ...
	            if (data.suc) {
	              ...
	              setTimeout(function () {
	                dispatch((0, _immutable.fromJS)(_Action.Action.pro_stateClickAction).mergeDeep({
	                  state: 'Rejected'
	                }).toJSON());
	              }, 1);
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MapStateToProps = __webpack_require__(748);

	var _MapDispatchToProps = __webpack_require__(752);
	...
	var _mockData = __webpack_require__(759);
			...
			value: function domInit(param) {
				...
				param.barItemDom.push(_react2.default.createElement(
					...
					{ href: 'javascript:;', className: me.choseBarItemCls(0), onClick: function onClick(e) {
							return param.onMain_TabbarClick(e, 0);
						} },
				...
				param.barItemDom.push(_react2.default.createElement(
					...
					{ href: 'javascript:;', className: me.choseBarItemCls(1), onClick: function onClick(e) {
							return param.onMain_TabbarClick(e, 1);
						} },
				...
				param.barItemDom.push(_react2.default.createElement(
					...
					{ href: 'javascript:;', className: me.choseBarItemCls(2), onClick: function onClick(e) {
							return param.onMain_TabbarClick(e, 2);
						} },
				...
				param.barItemDom.push(_react2.default.createElement(
					...
					{ href: 'javascript:;', className: me.choseBarItemCls(3), onClick: function onClick(e) {
							return param.onMain_TabbarClick(e, 3);
						} },
	        ...
	        return _react2.default.createElement(
	          ...
	          { href: 'javascript:;', className: me.choseBarItemCls(index == itemIndex),
	            onClick: function onClick(e) {
	              return me.props.onTabClick(e, 0);
	            } },
