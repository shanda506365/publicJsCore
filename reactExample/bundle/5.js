...
// module
exports.push([module.i, ".rongqi{overflow:hidden;white-space:nowrap;text-overflow:ellipsis;width:162px;height:30px}.children{display:inline-block}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/less-loader/index.js??ref--1-2!./test.less", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--1-1!../node_modules/less-loader/index.js??ref--1-2!./test.less");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
